...
const CandyMachine = ({ walletAddress }) => {
  ...
  const renderMintedItems = () => (
    <div className="gif-container">
      <p className="sub-text">Your Mints ✨</p>
    ...
    machineStats && (
      <>
        <div className="machine-container">
          {renderDropTimer()}
          <p className="machine-header">Mint yourself an OhBoy NFT</p>
          <p className="drop-date">{`Dropping on: ${machineStats.goLiveDateTimeString}`}</p>
          <p className="mint-counter">{`Items Minted: ${machineStats.itemsRedeemed} / ${machineStats.itemsAvailable}`}</p>
        ...
        {isLoadingMints && <p>LOADING YOUR MINTS...</p>}
